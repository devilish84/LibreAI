...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::awt::XWindowListener > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::awt::XWindowListener > >::get();
}

::css::uno::Type const & ::css::awt::XWindowListener::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::awt::XWindowListener >::get();
}
