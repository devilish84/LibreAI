...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::awt::XSpinValue > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::awt::XSpinValue > >::get();
}

::css::uno::Type const & ::css::awt::XSpinValue::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::awt::XSpinValue >::get();
}
