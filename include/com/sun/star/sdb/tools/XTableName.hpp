...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::sdb::tools::XTableName > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::sdb::tools::XTableName > >::get();
}

::css::uno::Type const & ::css::sdb::tools::XTableName::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::sdb::tools::XTableName >::get();
}
