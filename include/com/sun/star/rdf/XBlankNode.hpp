...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::rdf::XBlankNode > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::rdf::XBlankNode > >::get();
}

::css::uno::Type const & ::css::rdf::XBlankNode::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::rdf::XBlankNode >::get();
}
