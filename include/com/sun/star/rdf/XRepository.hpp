...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::rdf::XRepository > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::rdf::XRepository > >::get();
}

::css::uno::Type const & ::css::rdf::XRepository::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::rdf::XRepository >::get();
}
