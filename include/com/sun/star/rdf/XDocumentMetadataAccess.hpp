...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::rdf::XDocumentMetadataAccess const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[1] = ::cppu::UnoType< const ::css::uno::Reference< ::css::rdf::XRepositorySupplier > >::get().getTypeLibType();
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::rdf::XDocumentMetadataAccess > const *) {
...
::css::uno::Type const & ::css::rdf::XDocumentMetadataAccess::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::rdf::XDocumentMetadataAccess >::get();
}
