...
inline PersistenceFailureException::PersistenceFailureException(
...
inline PersistenceFailureException::PersistenceFailureException(const ::rtl::OUString& Message_, const ::css::uno::Reference< ::css::uno::XInterface >& Context_
#if defined LIBO_USE_SOURCE_LOCATION
    , std::experimental::source_location location
#endif
)
...
PersistenceFailureException::PersistenceFailureException(PersistenceFailureException const & the_other): ::css::uno::Exception(the_other) {}
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::auth::PersistenceFailureException const *) {
    return ::cppu::UnoType< ::css::auth::PersistenceFailureException >::get();
}
