...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::auth::XSSOManagerFactory > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::auth::XSSOManagerFactory > >::get();
}

::css::uno::Type const & ::css::auth::XSSOManagerFactory::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::auth::XSSOManagerFactory >::get();
}
