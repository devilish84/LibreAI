...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::inspection::XPropertyControl > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::inspection::XPropertyControl > >::get();
}

::css::uno::Type const & ::css::inspection::XPropertyControl::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::inspection::XPropertyControl >::get();
}
