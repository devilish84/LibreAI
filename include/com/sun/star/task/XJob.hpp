...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::task::XJob > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::task::XJob > >::get();
}

::css::uno::Type const & ::css::task::XJob::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::task::XJob >::get();
}
