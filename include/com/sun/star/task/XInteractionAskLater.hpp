...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::task::XInteractionAskLater > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::task::XInteractionAskLater > >::get();
}

::css::uno::Type const & ::css::task::XInteractionAskLater::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::task::XInteractionAskLater >::get();
}
