...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::xml::dom::events::XMutationEvent > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::xml::dom::events::XMutationEvent > >::get();
}

::css::uno::Type const & ::css::xml::dom::events::XMutationEvent::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::xml::dom::events::XMutationEvent >::get();
}
