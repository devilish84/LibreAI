...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::xml::crypto::XCipherContext > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::xml::crypto::XCipherContext > >::get();
}

::css::uno::Type const & ::css::xml::crypto::XCipherContext::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::xml::crypto::XCipherContext >::get();
}
