...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XSingletonTypeDescription const *) {
    ...
    if ( !the_type )
    {
        ...
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.reflection.XSingletonTypeDescription", 1, aSuperTypes );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::reflection::XSingletonTypeDescription > const *) {
...
::css::uno::Type const & ::css::reflection::XSingletonTypeDescription::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::reflection::XSingletonTypeDescription >::get();
}
