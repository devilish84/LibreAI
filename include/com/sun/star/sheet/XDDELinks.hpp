...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::sheet::XDDELinks > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::sheet::XDDELinks > >::get();
}

::css::uno::Type const & ::css::sheet::XDDELinks::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::sheet::XDDELinks >::get();
}
