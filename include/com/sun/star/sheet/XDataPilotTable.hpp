...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::sheet::XDataPilotTable > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::sheet::XDataPilotTable > >::get();
}

::css::uno::Type const & ::css::sheet::XDataPilotTable::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::sheet::XDataPilotTable >::get();
}
