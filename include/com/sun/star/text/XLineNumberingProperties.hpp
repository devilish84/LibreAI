...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::text::XLineNumberingProperties > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::text::XLineNumberingProperties > >::get();
}

::css::uno::Type const & ::css::text::XLineNumberingProperties::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::text::XLineNumberingProperties >::get();
}
