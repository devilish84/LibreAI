...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::linguistic2::XLinguProperties const *) {
    ...
    if ( !the_type )
    {
        ...
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.linguistic2.XLinguProperties", 1, aSuperTypes );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::linguistic2::XLinguProperties > const *) {
...
::css::uno::Type const & ::css::linguistic2::XLinguProperties::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::linguistic2::XLinguProperties >::get();
}
