...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::linguistic2::XProofreadingIterator > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::linguistic2::XProofreadingIterator > >::get();
}

::css::uno::Type const & ::css::linguistic2::XProofreadingIterator::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::linguistic2::XProofreadingIterator >::get();
}
