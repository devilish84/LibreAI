...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::mozilla::XProfileDiscover > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::mozilla::XProfileDiscover > >::get();
}

::css::uno::Type const & ::css::mozilla::XProfileDiscover::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::mozilla::XProfileDiscover >::get();
}
