...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::util::XSortable > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::util::XSortable > >::get();
}

::css::uno::Type const & ::css::util::XSortable::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::util::XSortable >::get();
}
