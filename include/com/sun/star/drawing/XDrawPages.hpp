...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::drawing::XDrawPages > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::drawing::XDrawPages > >::get();
}

::css::uno::Type const & ::css::drawing::XDrawPages::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::drawing::XDrawPages >::get();
}
