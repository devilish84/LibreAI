...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::form::XUpdateBroadcaster > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::form::XUpdateBroadcaster > >::get();
}

::css::uno::Type const & ::css::form::XUpdateBroadcaster::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::form::XUpdateBroadcaster >::get();
}
