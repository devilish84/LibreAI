...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::form::XErrorBroadcaster > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::form::XErrorBroadcaster > >::get();
}

::css::uno::Type const & ::css::form::XErrorBroadcaster::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::form::XErrorBroadcaster >::get();
}
