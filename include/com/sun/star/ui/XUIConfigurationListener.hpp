...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::ui::XUIConfigurationListener > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::ui::XUIConfigurationListener > >::get();
}

::css::uno::Type const & ::css::ui::XUIConfigurationListener::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::ui::XUIConfigurationListener >::get();
}
