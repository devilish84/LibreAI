...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::datatransfer::XTransferable > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::datatransfer::XTransferable > >::get();
}

::css::uno::Type const & ::css::datatransfer::XTransferable::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::datatransfer::XTransferable >::get();
}
