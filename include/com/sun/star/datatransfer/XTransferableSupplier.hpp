...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::datatransfer::XTransferableSupplier > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::datatransfer::XTransferableSupplier > >::get();
}

::css::uno::Type const & ::css::datatransfer::XTransferableSupplier::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::datatransfer::XTransferableSupplier >::get();
}
