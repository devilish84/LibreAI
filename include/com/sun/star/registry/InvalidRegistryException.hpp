...
inline InvalidRegistryException::InvalidRegistryException(
...
inline InvalidRegistryException::InvalidRegistryException(const ::rtl::OUString& Message_, const ::css::uno::Reference< ::css::uno::XInterface >& Context_
#if defined LIBO_USE_SOURCE_LOCATION
    , std::experimental::source_location location
#endif
)
...
InvalidRegistryException::InvalidRegistryException(InvalidRegistryException const & the_other): ::css::uno::Exception(the_other) {}
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::registry::InvalidRegistryException const *) {
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::registry::InvalidRegistryException const *) {
    return ::cppu::UnoType< ::css::registry::InvalidRegistryException >::get();
}
