#ifndef INCLUDED_COM_SUN_STAR_REGISTRY_XIMPLEMENTATIONREGISTRATION_HPP
#define INCLUDED_COM_SUN_STAR_REGISTRY_XIMPLEMENTATIONREGISTRATION_HPP
...
struct theXImplementationRegistrationType : public rtl::StaticWithInit< ::css::uno::Type *, theXImplementationRegistrationType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.registry.XImplementationRegistration" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.registry.XImplementationRegistration::registerImplementation" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.registry.XImplementationRegistration::revokeImplementation" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.registry.XImplementationRegistration::getImplementations" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.registry.XImplementationRegistration::checkInstantiation" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::registry::XImplementationRegistration const *) {
    const ::css::uno::Type &rRet = *detail::theXImplementationRegistrationType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName2( "xReg" );
                ::rtl::OUString sParamType2( "com.sun.star.registry.XSimpleRegistry" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "aLocation" );
                ::rtl::OUString sParamType0( "string" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_STRING;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "xReg" );
                ::rtl::OUString sParamType1( "com.sun.star.registry.XSimpleRegistry" );
                aParameters[1].pParamName = sParamName1.pData;
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::registry::XImplementationRegistration > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::registry::XImplementationRegistration > >::get();
}

::css::uno::Type const & ::css::registry::XImplementationRegistration::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::registry::XImplementationRegistration >::get();
}

#endif // INCLUDED_COM_SUN_STAR_REGISTRY_XIMPLEMENTATIONREGISTRATION_HPP
