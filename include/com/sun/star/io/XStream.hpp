...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::io::XStream > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::io::XStream > >::get();
}

::css::uno::Type const & ::css::io::XStream::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::io::XStream >::get();
}
