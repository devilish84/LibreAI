...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::io::XOutputStream > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::io::XOutputStream > >::get();
}

::css::uno::Type const & ::css::io::XOutputStream::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::io::XOutputStream >::get();
}
