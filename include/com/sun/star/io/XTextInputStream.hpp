...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::io::XTextInputStream > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::io::XTextInputStream > >::get();
}

::css::uno::Type const & ::css::io::XTextInputStream::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::io::XTextInputStream >::get();
}
