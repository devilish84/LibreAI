#ifndef INCLUDED_COM_SUN_STAR_BEANS_XFASTPROPERTYSET_HPP
#define INCLUDED_COM_SUN_STAR_BEANS_XFASTPROPERTYSET_HPP
...
struct theXFastPropertySetType : public rtl::StaticWithInit< ::css::uno::Type *, theXFastPropertySetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XFastPropertySet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XFastPropertySet::setFastPropertyValue" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XFastPropertySet::getFastPropertyValue" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XFastPropertySet const *) {
    const ::css::uno::Type &rRet = *detail::theXFastPropertySetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "nHandle" );
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::beans::XFastPropertySet > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::beans::XFastPropertySet > >::get();
}

::css::uno::Type const & ::css::beans::XFastPropertySet::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::beans::XFastPropertySet >::get();
}

#endif // INCLUDED_COM_SUN_STAR_BEANS_XFASTPROPERTYSET_HPP
