...
{
    return operator==( static_cast< ::css::beans::GetPropertyTolerantResult>(the_lhs), static_cast< ::css::beans::GetPropertyTolerantResult>(the_rhs) )
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::GetDirectPropertyTolerantResult const *) {
    ...
    if (the_type == 0) {
        ...
        ::typelib_static_struct_type_init(&the_type, "com.sun.star.beans.GetDirectPropertyTolerantResult", ::cppu::UnoType< ::css::beans::GetPropertyTolerantResult >::get().getTypeLibType(), 1, the_members, 0);
    }
