#ifndef INCLUDED_COM_SUN_STAR_BEANS_XMULTIPROPERTYSET_HPP
#define INCLUDED_COM_SUN_STAR_BEANS_XMULTIPROPERTYSET_HPP
...
struct theXMultiPropertySetType : public rtl::StaticWithInit< ::css::uno::Type *, theXMultiPropertySetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XMultiPropertySet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XMultiPropertySet::getPropertySetInfo" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XMultiPropertySet::setPropertyValues" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.beans.XMultiPropertySet::getPropertyValues" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.beans.XMultiPropertySet::addPropertiesChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[3],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName3.pData );
        ::rtl::OUString sMethodName4( "com.sun.star.beans.XMultiPropertySet::removePropertiesChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[4],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName4.pData );
        ::rtl::OUString sMethodName5( "com.sun.star.beans.XMultiPropertySet::firePropertiesChangeEvent" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XMultiPropertySet const *) {
    const ::css::uno::Type &rRet = *detail::theXMultiPropertySetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "aPropertyNames" );
                ...
                ::rtl::OUString sParamName1( "aValues" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamType1( "com.sun.star.beans.XPropertiesChangeListener" );
                aParameters[1].pParamName = sParamName1.pData;
            ...
            }
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.beans.XPropertiesChangeListener" );
                aParameters[0].pParamName = sParamName0.pData;
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::beans::XMultiPropertySet > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::beans::XMultiPropertySet > >::get();
}

::css::uno::Type const & ::css::beans::XMultiPropertySet::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::beans::XMultiPropertySet >::get();
}

#endif // INCLUDED_COM_SUN_STAR_BEANS_XMULTIPROPERTYSET_HPP
