...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::beans::XProperty > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::beans::XProperty > >::get();
}

::css::uno::Type const & ::css::beans::XProperty::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::beans::XProperty >::get();
}
