...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::script::XStorageBasedLibraryContainer const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[0] = ::cppu::UnoType< const ::css::uno::Reference< ::css::script::XPersistentLibraryContainer > >::get().getTypeLibType();
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::script::XStorageBasedLibraryContainer > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::script::XStorageBasedLibraryContainer > >::get();
}

::css::uno::Type const & ::css::script::XStorageBasedLibraryContainer::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::script::XStorageBasedLibraryContainer >::get();
}
