...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::script::XScriptEventsAttacher > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::script::XScriptEventsAttacher > >::get();
}

::css::uno::Type const & ::css::script::XScriptEventsAttacher::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::script::XScriptEventsAttacher >::get();
}
