...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::script::XLibraryContainerExport > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::script::XLibraryContainerExport > >::get();
}

::css::uno::Type const & ::css::script::XLibraryContainerExport::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::script::XLibraryContainerExport >::get();
}
