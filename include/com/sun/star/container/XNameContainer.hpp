#ifndef INCLUDED_COM_SUN_STAR_CONTAINER_XNAMECONTAINER_HPP
#define INCLUDED_COM_SUN_STAR_CONTAINER_XNAMECONTAINER_HPP
...
struct theXNameContainerType : public rtl::StaticWithInit< ::css::uno::Type *, theXNameContainerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XNameContainer" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::container::XNameReplace > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[2] = { 0,0 };
        ::rtl::OUString sMethodName0( "com.sun.star.container.XNameContainer::insertByName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XNameContainer::removeByName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XNameContainer const *) {
    const ::css::uno::Type &rRet = *detail::theXNameContainerType::get();
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::container::XNameContainer > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::container::XNameContainer > >::get();
}

::css::uno::Type const & ::css::container::XNameContainer::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::container::XNameContainer >::get();
}

#endif // INCLUDED_COM_SUN_STAR_CONTAINER_XNAMECONTAINER_HPP
