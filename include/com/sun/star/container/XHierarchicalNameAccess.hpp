...
#define INCLUDED_COM_SUN_STAR_CONTAINER_XHIERARCHICALNAMEACCESS_HPP
...
struct theXHierarchicalNameAccessType : public rtl::StaticWithInit< ::css::uno::Type *, theXHierarchicalNameAccessType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XHierarchicalNameAccess" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XHierarchicalNameAccess::getByHierarchicalName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XHierarchicalNameAccess::hasByHierarchicalName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XHierarchicalNameAccess const *) {
    const ::css::uno::Type &rRet = *detail::theXHierarchicalNameAccessType::get();
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::container::XHierarchicalNameAccess > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::container::XHierarchicalNameAccess > >::get();
}

::css::uno::Type const & ::css::container::XHierarchicalNameAccess::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::container::XHierarchicalNameAccess >::get();
}

#endif // INCLUDED_COM_SUN_STAR_CONTAINER_XHIERARCHICALNAMEACCESS_HPP
