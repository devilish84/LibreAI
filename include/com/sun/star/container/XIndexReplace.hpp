...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::container::XIndexReplace > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::container::XIndexReplace > >::get();
}

::css::uno::Type const & ::css::container::XIndexReplace::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::container::XIndexReplace >::get();
}
