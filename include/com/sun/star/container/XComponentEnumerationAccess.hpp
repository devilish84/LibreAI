...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::container::XComponentEnumerationAccess > const *) {
...
::css::uno::Type const & ::css::container::XComponentEnumerationAccess::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::container::XComponentEnumerationAccess >::get();
}
