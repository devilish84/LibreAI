...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::report::XFormattedField const *) {
    ...
    if ( !the_type )
    {
        ...
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.report.XFormattedField", 1, aSuperTypes );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::report::XFormattedField > const *) {
...
::css::uno::Type const & ::css::report::XFormattedField::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::report::XFormattedField >::get();
}
