...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::report::XImageControl const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[1] = ::cppu::UnoType< const ::css::uno::Reference< ::css::form::XImageProducerSupplier > >::get().getTypeLibType();
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::report::XImageControl > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::report::XImageControl > >::get();
}

::css::uno::Type const & ::css::report::XImageControl::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::report::XImageControl >::get();
}
