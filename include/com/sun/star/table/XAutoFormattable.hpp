...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::table::XAutoFormattable > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::table::XAutoFormattable > >::get();
}

::css::uno::Type const & ::css::table::XAutoFormattable::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::table::XAutoFormattable >::get();
}
