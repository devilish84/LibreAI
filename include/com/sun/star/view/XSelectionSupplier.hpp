...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::view::XSelectionSupplier > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::view::XSelectionSupplier > >::get();
}

::css::uno::Type const & ::css::view::XSelectionSupplier::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::view::XSelectionSupplier >::get();
}
