...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::svg::XSVGWriter > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::svg::XSVGWriter > >::get();
}

::css::uno::Type const & ::css::svg::XSVGWriter::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::svg::XSVGWriter >::get();
}
