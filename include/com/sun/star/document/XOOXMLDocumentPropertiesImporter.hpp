...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::document::XOOXMLDocumentPropertiesImporter > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::document::XOOXMLDocumentPropertiesImporter > >::get();
}

::css::uno::Type const & ::css::document::XOOXMLDocumentPropertiesImporter::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::document::XOOXMLDocumentPropertiesImporter >::get();
}
