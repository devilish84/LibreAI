...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::chart2::XFormattedString2 const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[1] = ::cppu::UnoType< const ::css::uno::Reference< ::css::chart2::XFormattedString > >::get().getTypeLibType();
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.chart2.XFormattedString2", 2, aSuperTypes );
    }
