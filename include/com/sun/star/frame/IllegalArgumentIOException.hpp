...
inline IllegalArgumentIOException::IllegalArgumentIOException(
...
inline IllegalArgumentIOException::IllegalArgumentIOException(const ::rtl::OUString& Message_, const ::css::uno::Reference< ::css::uno::XInterface >& Context_
#if defined LIBO_USE_SOURCE_LOCATION
    , std::experimental::source_location location
#endif
)
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::frame::IllegalArgumentIOException const *) {
    ...
    if ( !the_type )
    {
        ...
        typelib_static_compound_type_init( &the_type, typelib_TypeClass_EXCEPTION, "com.sun.star.frame.IllegalArgumentIOException", rBaseType.getTypeLibType(), 0,  0 );
    }
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::frame::IllegalArgumentIOException const *) {
