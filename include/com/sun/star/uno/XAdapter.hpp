...
struct theXAdapterType : public rtl::StaticWithInit< ::css::uno::Type *, theXAdapterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.uno.XAdapter" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.uno.XAdapter::queryAdapted" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.uno.XAdapter::addReference" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.uno.XAdapter::removeReference" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::uno::XAdapter const *) {
    const ::css::uno::Type &rRet = *detail::theXAdapterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "xRef" );
                ::rtl::OUString sParamType0( "com.sun.star.uno.XReference" );
...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::uno::XAdapter > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::uno::XAdapter > >::get();
}

::css::uno::Type const & ::css::uno::XAdapter::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::uno::XAdapter >::get();
}
