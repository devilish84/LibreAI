...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::configuration::backend::XSingleLayerStratum > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::configuration::backend::XSingleLayerStratum > >::get();
}

::css::uno::Type const & ::css::configuration::backend::XSingleLayerStratum::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::configuration::backend::XSingleLayerStratum >::get();
}
