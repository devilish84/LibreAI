...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::ucb::XContentCreator > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::ucb::XContentCreator > >::get();
}

::css::uno::Type const & ::css::ucb::XContentCreator::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::ucb::XContentCreator >::get();
}
