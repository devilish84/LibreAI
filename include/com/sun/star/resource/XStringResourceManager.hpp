...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::resource::XStringResourceManager const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[0] = ::cppu::UnoType< const ::css::uno::Reference< ::css::resource::XStringResourceResolver > >::get().getTypeLibType();
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.resource.XStringResourceManager", 1, aSuperTypes );
    }
