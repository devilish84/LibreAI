...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::graphic::XGraphic > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::graphic::XGraphic > >::get();
}

::css::uno::Type const & ::css::graphic::XGraphic::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::graphic::XGraphic >::get();
}
