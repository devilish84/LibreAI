...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::gallery::XGalleryItem > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::gallery::XGalleryItem > >::get();
}

::css::uno::Type const & ::css::gallery::XGalleryItem::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::gallery::XGalleryItem >::get();
}
