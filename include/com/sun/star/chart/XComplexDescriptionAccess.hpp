...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::chart::XComplexDescriptionAccess const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[0] = ::cppu::UnoType< const ::css::uno::Reference< ::css::chart::XChartDataArray > >::get().getTypeLibType();
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.chart.XComplexDescriptionAccess", 1, aSuperTypes );
    }
